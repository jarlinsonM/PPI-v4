        ...
        <div>
            <div className="container text-center">
                <div className="row align-items-start ">
                    <div className="col-4 card separacion tamLarg">
                        <img src={corporalM} alt=" " />
                        <div className='card-body'>
                            <h2 className='h2'>Masaje Corporal</h2>
                            ...
                            <h3 className='card-title text-center h2'>Beneficios</h3>
                            <ul>
                    ...
                    <div className="col-4 card separacion tamLarg">
                        <img src={facial} alt="" />
                        <div className='card-body'>
                            <h2 className='h2'>Masaje Facial</h2>
                            <p className='card-text'>
                    ...
                    <div className="col-4 card separacion tamLarg">
                        <img src={shiatsu} alt="" />
                        <div className='card-body'>
                            <h2 className='h2'>Masaje Shiatsu</h2>
                            <p className='card-text'>
            ...
            <div className="container text-center">
                <div className="row align-items-start">
                    <div className="col-4 card separacion">
                        <img src={masajeF} alt="" />
                        <div className='card-body'>
                            <h2 className='h2'>Masaje fisioterapeutico</h2>
                            <p className='card-text'>
                                los masajes terapéuticos incluye una serie de técnicas de masaje utilizados para el
                                tratamiento de diversas patologías que afectan el sistema neuromuscular
                                 y esquelético por lo que deben ser aplicados por fisioterapeutaprofesionales 
                            </p>
                            <h3 className='card-title text-center h2'>Beneficios</h3>
                            <ul>
                                <li>Aumenta el rango de movilidad </li>
                                <li>Mejora las condiciones de los tejidos blandos</li>
                                <li>Genera una sensación de tranquilidad y bienestar.</li>
                            </ul>
                            <input type="button" className='btn btn-success' value={'Agendar Servicio'} />
                        </div>
                    </div>
                    <div class="col-4 card separacion">
                        ...
                        <div className='card-body'>
                            <h2 className='h2'>Masaje Deportivo</h2>
                            <p className='card-text'>
                    ...
                    <div class="col-4 card separacion">
                        <img src={masajeT} alt="" />
                        <div className='card-body'>
                            <h2 className='h2'>Masaje Turco</h2>
                            <p className='card-text'>
                                El masaje turco se practica en un baño de vapor cálido. 
                                Es un antiguo método de curación y relajación que utiliza 
                                técnicas manuales, calor y vapor para ayudar a desintoxicar
                                el cuerpo, mejorar la circulación y aliviar el estrés.</p>
                                 
                            <h3 className='card-title text-center h2'>Beneficios</h3>
                            <ul>
                                <li>Relaja los músculos y reduce el estrés.</li>
                                <li>Alivia el dolor y mejora la movilidad articular.</li>
                                <li>Purifica la piel al eliminar las impurezas.</li>
                            </ul>
                            <input type="button" className='btn btn-success' value={'Agendar Servicio'} />
                        </div>
                    </div>
            ...
            <div class="row justify-content-around text-center">
                <div class="col-4 card separacionex">
                    <img src={Planfamilia} alt="" />
                    <div className='card-body'>
                        <h2 className='h2'>Plan Familiar</h2>
                        <p className='card-text'>
                ...
                <div class="col-4 card separacionex">
                    ...
                    <div className='card-body'>
                        ...
                        <h2 className='h2'>Plan Pareja</h2>
                        <p className='card-text'>
